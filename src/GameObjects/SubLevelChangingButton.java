...
public class SubLevelChangingButton extends Button{
    ...
    String SubLevel;
    public SubLevelChangingButton(int w, int h, int x, int y, String textureName, String messageName, String id, String lvl) throws IOException, FontFormatException {
